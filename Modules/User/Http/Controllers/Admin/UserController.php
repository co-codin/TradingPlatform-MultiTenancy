...
final class UserController extends Controller
{
     ...
     *                     @OA\Items(@OA\Property(property="id", type="integer"))),
     *                 @OA\Property(property="brands", type="array", description="Array of brands ID",
     *                     @OA\Items(@OA\Property(property="id", type="integer")),
     *                         @OA\Property(property="pivot", type="array", description="Array of brands ID",
     *                             @OA\Items(@OA\Property(property="is_default", type="boolean")),
     *                         ),
     *                 ),
    ...
    {
        $users = $this->userBatchService
            ->setAuthUser($request->user())
            ->updateBatch($request->validated('users', []));

        abort_if($users->isEmpty(), ResponseAlias::HTTP_UNAUTHORIZED, __('Cant update user'));
