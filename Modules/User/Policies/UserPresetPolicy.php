...
class UserPresetPolicy extends BasePolicy
{
    ...
    public function view(User $user, Preset $preset): bool
    {
        return $preset->user_id === $user->id ||
            $user->can(UserPresetPermission::VIEW_USER_PRESET_OPTIONS);
    }
    ...
    {
        return $user->can(UserPresetPermission::CREATE_USER_PRESET_OPTIONS);
    }
    ...
    {
        return $preset->user_id === $user->id ||
            $user->can(UserPresetPermission::EDIT_USER_PRESET_OPTIONS);
    }
    ...
    {
        return $preset->user_id === $user->id ||
            $user->can(UserPresetPermission::DELETE_USER_PRESET_OPTIONS);
    }
}
