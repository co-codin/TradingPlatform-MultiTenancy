...
class CustomerFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'country_id' => $this->faker->randomElement(Country::factory()->make()->pluck('id')),
            'phone2' => $this->faker->phoneNumber(),
            'language_id' => $this->faker->randomElement(Language::factory()->make()->pluck('id')),
            'city' => $this->faker->city(),
            'address' => $this->faker->address(),
            'postal_code' => $this->faker->postcode(),
            'desk_id' => $this->faker->randomElement(Desk::factory()->make()->pluck('id')),
            'department_id' => $this->faker->randomElement(Department::factory()->make()->pluck('id')),
