 ...
 *
 * @OA\Schema (
 *     schema="FTDCustomerCollection",
 *     type="object",
 *     @OA\Property(
 *         property="data",
 *         type="array",
 *         @OA\Items(ref="#/components/schemas/FTDCustomer")
 *     ),
 *     @OA\Property(
 *         property="meta",
 *         type="object",
 ...
 *
 * @OA\Schema (
 *     schema="FTDCustomerResource",
 *     type="object",
 *     @OA\Property(
 *         property="data",
 *         type="object",
 *         ref="#/components/schemas/FTDCustomer"
 *     )
 * )
 *
 * Class FTDCustomerResource
 * @mixin Customer
 */
