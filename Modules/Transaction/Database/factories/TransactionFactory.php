...
final class TransactionFactory extends BaseFactory
{
    ...
    public function definition(): array
    {
        ...
        return [
            'type' => $type,
            'mt5_type_id' => TransactionsMt5Type::firstWhere('name', $mt5Type),
            'status_id' => TransactionStatus::inRandomOrder()->first(),
            'creator_id' => $fromCustomer ? $customer : User::inRandomOrder()->first(),
            ...
            'method_id' => TransactionsMethod::inRandomOrder()->first(),
            'wallet_id' => $wallet,
            'currency_id' => $wallet->currency,
            'external_id' => $this->faker->boolean ? $this->faker->uuid : $this->faker->numberBetween(),
            'description' => $this->faker->boolean(90) ? null : $this->faker->sentence,
        ];
    }
}
